...
<body>
  <?php
  session_start();
    $_SESSION['to_email']="velikantirupendra369@gmail.com";
  ?>
...
<div class="container">
    <div class="row mb-2">
        <div class="col-12 text-center pt-3">
            <h1 style="color:black;font-size:50px;font-family:Cooper"><b>Annapurna Boys Hostel<b></h1>
...
<div class="mySlides fade">
  ...
  <img src="hostel51.jpg" style="width:100%">
  <div class="text"></div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="hostel52.jpg" style="width:100%">
  <div class="text"></div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="hostel53.jpg" style="width:100%">
  <div class="text"></div>
</div>
<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="hostel54.jpg" style="width:100%">
  <div class="text"></div>
</div>
...
<div class="container ">
  ...
  <tr><td><h1><strong>OwnerName: B.kishore Reddy</strong></h1></td></tr>
  <tr><td><h1><strong>Owner Contact: </strong>966644210</h1></td></tr>
