...
<style>
body{
	background-image:url("https://wallpapercave.com/wp/wp2610926.jpg");
...
.tab{
	...
	background-color:RGB(207, 186, 130);
}
</style>  
</head>
<body>
  <?php
  session_start();
  $_SESSION['mobile']="918374695363";
    $_SESSION['to_email']="sauravpanjiyar0309@gmail.com";
  ?>
...
<div class="container">
    <div class="row mb-2">
        <div class="col-12 text-center pt-3">
            <h1 style="color:white;font-size:50px;font-family:Cooper"><b>Vikas    Boys  Hostel<b></h1>
...
<div class="mySlides fade">
  ...
  <img src="hostel11.jpeg" style="width:100%">
  <div class="text"></div>
</div>

<div class="mySlides fade">
  <div class="numbertext">2 / 3</div>
  <img src="hostel12.jpeg" style="width:100%">
  <div class="text"></div>
</div>

<div class="mySlides fade">
  <div class="numbertext">3 / 3</div>
  <img src="hostel13.jpeg" style="width:100%">
  <div class="text"></div>
</div>
...
<div class="container ">
  ...
  <table class="table table-hover" border="2px solid red"  width="100%">
	...
	<tr><td><h1><strong>Address:</strong>Sree sainathnagar A.Rangampeta Tirupati 517102</h1></td></tr>
	...
	<strong>1st Installment:</strong>24,000/-<br>   <strong>2nd Installment</strong>:24,000/-</h1></td></tr>
  </table>
  </div>
</div>
